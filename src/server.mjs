...
new SocketClient('kp3rusdt', 1, 3600000); 
new SocketClient('ksmusdt', 2, 3605000); 
new SocketClient('laziousdt', 3, 3610000); 
new SocketClient('ldousdt', 4, 3615000); 
new SocketClient('leverusdt', 5, 3620000); 
new SocketClient('linausdt', 6, 3625000); 
new SocketClient('linkusdt', 7, 3630000); 
new SocketClient('litusdt', 8, 3635000); 
new SocketClient('lokausdt', 9, 3640000); 
new SocketClient('lptusdt', 10, 3645000); 
new SocketClient('lrcusdt', 11, 3650000); 
new SocketClient('lskusdt', 12, 3655000); 
new SocketClient('ltcusdt', 13, 3660000); 
new SocketClient('ltousdt', 14, 3665000); 
new SocketClient('lunausdt', 15, 3670000);
new SocketClient('luncusdt', 16, 3675000); 
new SocketClient('magicusdt', 17, 3680000); 
new SocketClient('manausdt', 18, 3685000); 
new SocketClient('maskusdt', 19, 3690000); 
new SocketClient('maticusdt', 20, 3695000); 
new SocketClient('mblusdt', 21, 3700000); 
new SocketClient('mboxusdt', 22, 3705000); 
new SocketClient('mcusdt', 23, 3710000); 
new SocketClient('mdtusdt', 24, 3715000); 
new SocketClient('mdxusdt', 25, 3720000); 
new SocketClient('minausdt', 27, 3730000);
new SocketClient('mkrusdt', 30, 3745000); 
new SocketClient('mlnusdt', 31, 3750000); 
new SocketClient('mobusdt', 32, 3755000); 
new SocketClient('movrusdt', 33, 3760000); 
new SocketClient('mtlusdt', 34, 3765000); 
new SocketClient('multiusdt', 35, 3770000); 
new SocketClient('nbtusdt', 36, 3775000);
new SocketClient('nearusdt', 37, 3780000);
new SocketClient('neblusdt', 38, 3785000); 
new SocketClient('neousdt', 39, 3790000); 
new SocketClient('nexousdt', 40, 3795000); 
